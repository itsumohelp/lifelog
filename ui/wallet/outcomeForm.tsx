                    ...
                    <tbody>
                        <tr>
                            ...
                            <td width='100' className='text-right'>
                                <div className='p-5'>
                                    <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2">登録</button>
                                </div>
                            </td>
                        </tr>
                    </tbody>
